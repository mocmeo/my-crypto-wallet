...
const defaultMeta = {
  ...
  description:
    'Crypto Wallet is the best ethereum wallet and cryptocurrency wallet to store your favourite tokens.',
  url: 'https://wallet.lamngo.dev',
  type: 'website',
  robots: 'follow, index',
  image: '',
};
    ...
    <Head>
      ...
      {meta.date && (
        <>
          ...
          <meta name='author' property='article:author' content='Lam Ngo' />
        </>
      )}
